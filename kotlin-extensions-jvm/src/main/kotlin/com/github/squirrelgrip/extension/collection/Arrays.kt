...
class ArrayHandler<T, U>(
    ...
    private fun evaluate(predicate: (U) -> Boolean, it: T): Boolean =
...
fun Array<String>.allByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.anyByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.countByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.filterByExpression(expression: String?, aliases: Map<String, String> = emptyMap()): List<String> =
...
fun <T> Array<T>.filterMapByExpression(
    ...
    aliases: Map<String, String> = emptyMap(),
    transform: (T) -> String = { it.toString() }
): List<T> = ArrayHandler(expression, this, StringCompiler, aliases, transform).filter()

fun <T> Array<T>.filterFlatMapByExpression(
    expression: String?,
    aliases: Map<String, String> = emptyMap(),
    transform: (T) -> Collection<String> = { setOf(it.toString()) }
): List<T> = ArrayHandler(expression, this, CollectionStringCompiler, aliases, transform).filter()

fun Array<String>.filterNotByExpression(expression: String?, aliases: Map<String, String> = emptyMap()): List<String> =
...
fun <T> Array<T>.filterNotMapByExpression(
    ...
    aliases: Map<String, String> = emptyMap(),
    transform: (T) -> String = { it.toString() }
): List<T> = ArrayHandler(expression, this, StringCompiler, aliases, transform).filterNot()

fun <T> Array<T>.filterNotFlatMapByExpression(
    expression: String?,
    aliases: Map<String, String> = emptyMap(),
    transform: (T) -> Collection<String> = { setOf(it.toString()) }
): List<T> = ArrayHandler(expression, this, CollectionStringCompiler, aliases, transform).filterNot()

fun Array<String>.findByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.firstByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.firstOrNullByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.indexOfFirstByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.indexOfLastByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.lastByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
...
fun Array<String>.partitionByExpression(expression: String?, aliases: Map<String, String> = emptyMap()) =
